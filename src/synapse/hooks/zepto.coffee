((root, factory) ->
    ...
    # as the common interface for ``Zepto`` objects.
    #
    # Compound interfaces correspond to other Zepto APIs such as ``attr``,
    ...
    # for use throughout the interfaces. For older versions of Zepto, ``attr``
    ...
    do ->
        ...
        # ### _data.FOO_
        # Gets and sets an attribute on the target element using the Zepto
        # data API.
        interfaces.register
            name: 'data'
            get: (key) -> @data(key)
    ...
    return {
        ...
        checkObjectType: (object) ->
            core.isString(object) or object.nodeType is 1 or core.isArray(object)
